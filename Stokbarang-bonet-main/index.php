    ...
    <div class="container p-1">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="index.php">Stok</a>
                </li>
                <li class="nav-item">
...
<div class="container mt-5">
    <h2 class="text-center fs-1 fw-bold">Daftar Stok Barang - Admin View</h2>
    ...
    <form class="d-flex mb-3" method="GET" action="admin.php">
        ...
        <ul class="pagination">
            ...
            for ($i = 1; $i <= $total_pages; $i++): ?>
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link" href="admin.php?page=<?= $i ?>&limit=<?= $limit ?>&search=<?= htmlspecialchars($search) ?>"><?= $i ?></a>
                </li>
            <?php endfor; ?>
        </ul>
    </nav>

...
$total_query = "SELECT COUNT(*) as total FROM tb_riwayat WHERE id_barang LIKE '%$search%'";
...
$query = "SELECT * FROM tb_riwayat WHERE id_barang LIKE '%$search%' ORDER BY tanggal DESC LIMIT $limit OFFSET $offset";
...
<head>
    ...
    <title>Riwayat Stok Barang - Admin View</title>
    ...
    <div class="container p-1">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="riwayat-admin.php">Histori</a>
                </li>
                <li class="nav-item">
...
<div class="container mt-5">
    <h2 class="text-center fs-1 fw-bold">Riwayat Pemasukan dan Pengeluaran Barang</h2>
    <div class="actions mb-3">
        <form method="GET" action="riwayat.php" class="d-inline">
            <div class="btn-group" role="group">
                ...
                <button type="submit" name="limit" value="all" class="btn btn-outline-secondary">All</button>
            </div>
        </form>
    </div>
    <form class="d-flex mb-3" method="GET" action="riwayat.php">
        ...
        <ul class="pagination">
            ...
            for ($i = 1; $i <= $total_pages; $i++): ?>
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link" href="riwayat.php?page=<?= $i ?>&limit=<?= $limit ?>&search=<?= htmlspecialchars($search) ?>"><?= $i ?></a>
                </li>
            <?php endfor; ?>
        </ul>
    </nav>

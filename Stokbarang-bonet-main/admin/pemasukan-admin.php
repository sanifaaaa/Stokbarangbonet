...
<div class="container mt-5">
    ...
    <div class="actions mb-3">
        ...
        <a href="create-pemasukan.php" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Barang</a>
        <!-- <a href="create-pemasukan-stok.php" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Stok</a> -->
    </div>
